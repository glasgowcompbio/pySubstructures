...
from pySubstructures.ms2lda.molnetenhancer import (
...
def create_graphml(
    ...
    try:
        ...
        motif_network = Mass2Motif_2_Network(
            edges, motifs, prob=pvalue, overlap=overlap, top=topx
        )
        motif_network["nodes"]["motifdb_url"] = motif_network["nodes"][
            "motifdb_url"
