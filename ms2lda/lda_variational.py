...
from pySubstructures.constants import SMALL_NUMBER
...
class VariationalLDA(object):
    ...
    def __init__(self, corpus=None, K=20, eta=0.1,
        ...
        :param eta: hyperparameter for topics (i.e. pseudo word counts)
        :param alpha: initial Dirichlet hyperparameter
        :param update_alpha: boolean to determine whether or not alpha is updated at each iteration
        :param word_index: a dictionary storing the position of each feature in numpy arrays.
    ...
    def _add_exact_fixed_topics(self, fixed_topics):
        """
        Adds exact fixed topics to seed the initial data structures
        :param fixed_topics:
        :return:
        """
    ...
    def run_vb(self, n_its=1, initialise=True):
        ...
        :param verbose: if True means it gives output each iteration
        :param initialise: if True means it initialises (i.e. restarts the algorithm)
        :return: None
        """
        if initialise:
            self.init_vb()
    ...
    def find_unique_words(self):
        """
        Finds the unique words in the corpus and assign them to indices
        :return:
        """
        word_index = {}
        pos = 0
    ...
    def get_expect_theta(self):
        ...
        :return: the expected topic probabilities for all documents
        """
    ...
    def make_dictionary(self, metadata=None, min_prob_to_keep_beta=1e-3,
        ...
        :param metadata:
        :param min_prob_to_keep_beta:
        :param min_prob_to_keep_phi:
        :param min_prob_to_keep_theta:
        :param filename:
        :param features:
        :param compute_overlaps:
        :return:
        """
